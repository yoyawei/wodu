Page({
  ...
  toBook: function (e) {
    wx.navigateTo({
      url: '../provide/bookdetail?bookid=' + e.currentTarget.dataset.bookid
    })
  },
  ...
  toGet: function (e) {
    if (this.data.userId == '' || this.data.token == '') {
      ...
      wx.navigateTo({
        url: '../provide/get?bookid=' + e.currentTarget.dataset.bookid + '&bookname=' + e.currentTarget.dataset.bookname
      })
    }
  }
})